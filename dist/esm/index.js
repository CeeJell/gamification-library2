...
const Achievement = ({ title, description, picture, percentage, children, borderStyle, pictureStyle, titleStyle, descriptionStyle, progressbarStyle, progressbarSliderStyle, progressbarTextStyle }) => {
