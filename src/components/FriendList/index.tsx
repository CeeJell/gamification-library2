...
const FriendList: React.FC<Props> = ({ children, borderStyle, titleStyle }) => {

    return (
        <div style={{border: "3px solid ", content: "", clear: "both", display: "table", borderColor: "#FF0099", borderRadius: "8px", 
        width: "400px", ...borderStyle}}>

            <div style={{margin: "auto"}}>
            <h1 style={{textDecorationLine: "underline", textAlign: "center", ...titleStyle}}>Friends</h1>
            </div>
