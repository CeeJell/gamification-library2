...
const AchievementList: React.FC<Props> = ({ children, borderStyle, titleStyle }) => {

    return (
        <div style={{border: "3px solid ", content: "", clear: "both", display: "table", borderColor: "#FF0099", borderRadius: "8px", 
        width: "1050px", height: "250px", ...borderStyle}}>

            <div style={{margin: "auto"}}>
            <h1 style={{textDecorationLine: "underline", textAlign: "center", ...titleStyle}}>Achievements</h1>
            </div>
